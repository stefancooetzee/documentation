...
.. warning:: There were changes to the 3rd party mailer library in Nextcloud 26:
    ...
    * NTLM authentication for Microsoft Exchange is not supported by the new mailer library. Use `basic authentication <https://learn.microsoft.com/en-us/exchange/client-developer/exchange-web-services/authentication-and-ews-in-exchange#basic-authentication>`_.
